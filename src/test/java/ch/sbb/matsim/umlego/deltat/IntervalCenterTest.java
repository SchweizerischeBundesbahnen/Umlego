...
class IntervalCenterTest {

	private static final double ONEDAY = 86400.0;

	@Test
	public void testIntervalCenterCalculations() {
		IntervalCenter calculator = new IntervalCenter();

		// slightly before interval
		Assertions.assertEquals(150.0, calculator.calculateDeltaTEarly(2900, 3000, 3100));
		...
		Assertions.assertEquals(150.0, calculator.calculateDeltaTLate(3200, 3000, 3100));

		// exactly on interval boundaries
		Assertions.assertEquals(50.0, calculator.calculateDeltaTEarly(3000, 3000, 3100));
		...
		Assertions.assertEquals(50.0, calculator.calculateDeltaTLate(3100, 3000, 3100));
		...
		Assertions.assertEquals(150.0, calculator.calculateDeltaTEarly(2900 + ONEDAY, 3000, 3100));
		Assertions.assertEquals(150.0, calculator.calculateDeltaTEarly(2900 + 2 * ONEDAY, 3000, 3100));
		Assertions.assertEquals(150.0, calculator.calculateDeltaTEarly(2900, 3000 + ONEDAY, 3100 + ONEDAY));
		Assertions.assertEquals(150.0, calculator.calculateDeltaTEarly(2900, 3000 + 2 * ONEDAY, 3100 + 2 * ONEDAY));
		...
		Assertions.assertEquals(150.0, calculator.calculateDeltaTLate(3200 + ONEDAY, 3000, 3100));
		Assertions.assertEquals(150.0, calculator.calculateDeltaTLate(3200 + 2 * ONEDAY, 3000, 3100));
		Assertions.assertEquals(150.0, calculator.calculateDeltaTLate(3200, 3000 + ONEDAY, 3100 + ONEDAY));
		Assertions.assertEquals(150.0, calculator.calculateDeltaTLate(3200, 3000 + 2 * ONEDAY, 3100 + 2 * ONEDAY));
	}
