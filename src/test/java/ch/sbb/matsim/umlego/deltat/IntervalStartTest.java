...
class IntervalStartTest {

	private static final double ONEDAY = 86400.0;

	@Test
	public void testIntervalStartCalculations() {
		IntervalStart calculator = new IntervalStart();
		...
		Assertions.assertEquals(200.0, calculator.calculateDeltaTLate(3200, 3000, 3100));
		...
		Assertions.assertEquals(100.0, calculator.calculateDeltaTLate(3100, 3000, 3100));

		// exactly in the middle of the interval
		Assertions.assertEquals(0.0, calculator.calculateDeltaTEarly(3050, 3000, 3100));
		Assertions.assertEquals(50.0, calculator.calculateDeltaTLate(3050, 3000, 3100));
		...
		Assertions.assertEquals(200.0, calculator.calculateDeltaTLate(3200 + ONEDAY, 3000, 3100));
		Assertions.assertEquals(200.0, calculator.calculateDeltaTLate(3200 + 2 * ONEDAY, 3000, 3100));
		Assertions.assertEquals(200.0, calculator.calculateDeltaTLate(3200, 3000 + ONEDAY, 3100 + ONEDAY));
		Assertions.assertEquals(200.0, calculator.calculateDeltaTLate(3200, 3000 + 2 * ONEDAY, 3100 + 2 * ONEDAY));
	}
